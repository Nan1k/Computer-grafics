...
void generateEllipse(float cx, float cy, float rx, float ry, int segments, std::vector<float>& vertices, std::vector<unsigned int>& indices) {
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Ellipse Example", nullptr, nullptr);
    if (!window) {
    ...
    generateEllipse(0.0f, 0.0f, 0.5f, 0.3f, 100, vertices, indices);
